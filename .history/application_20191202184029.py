...
def gconnect():
    ...
    code = request.data
    print('code from server is %s'  %code)
    try:
        # Upgrade the authorization code into a credentials object
        oauth_flow = flow_from_clientsecrets('client_secrets.json', scope='', redirect_uri='urn:ietf:wg:oauth:2.0:oob')
...
def delete_item(category_id,item_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('delete_item.html', category_id = category_id , item = itemToDelete)
